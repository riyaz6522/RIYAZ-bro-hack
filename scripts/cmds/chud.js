...
setTimeout(() => {a({body: "কিরে মাদারচোত রিয়াজ এর চুদন খাওয়ায় জন্য রেডি তো?" + "লে চুদা খা মাঙ্গের বেটা 😂😂" + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: " মাদারচোদ বোকাচোদা খানকির ছেলে রেন্ডিরছেলে তোর মারে রাস্তায় চুদি 🫦👀" + " " + name, mentions: arraytag})}, 28000);
setTimeout(() => {a({body: " তোকে চুদী সাথে তোর মারে,তোর বোনরে রাইতে চুদি🫠🥱" + " " + name, mentions: arraytag})}, 30000);
setTimeout(() => {a({body: " মাদারচোত জারজ সন্তান তোর মার দুধে মুতি তোর মার সাউয়ায় ১৮ ইন্চি হোল দিয়ে চুদী👅🤮" + " " + name, mentions: arraytag})}, 32000);
...
setTimeout(() => {a({body: "তোর মারে ১২ মাস ১২০০ স্টাইলে চুদি🥰" + " " + name, mentions: arraytag})}, 36000);
...
setTimeout(() => {a({body: " তোর মার ভোদায় ১৮ ইন্ছি সোনা ঢুকিয়ে রস বের করে করে ঘসঘস শব্দ বের করবো তোর মতো আরেকটা জারজ সন্তান 🙂🤡" + " " + name, mentions: arraytag})}, 44000);
setTimeout(() => {a({body: " তোমার গুষ্টি চুদী ব্রো 😸🖕🏿" + " " + name, mentions: arraytag})}, 460000);
setTimeout(() => {a({body: " তোর বোন রে কুত্তার হোল চুসাবো খানকির ছেলে" + " " + name, mentions: arraytag})}, 48000);
...
setTimeout(() => {a({body: "বোকাচোদার বাচ্চা  আব্বু ডাক মাফ করে দিবো😂" + " " + name, mentions: arraytag})} , 56000);
setTimeout(() => {a({body: " মাদারচোত বোকাচোদা খানকীর ছেলে 🤬" + " " + name, mentions: arraytag})} , 58000);
setTimeout(() => {a({body: " তোর মারে ডগি স্টাইলে চুদি দিনে ৭বার" + " " + name, mentions: arraytag})} , 60000);
...
setTimeout(() => {a({body: " আব্বু ডাক নাহলে অনলাইন আউট করে দিবো তোকে ফেরাউনের বাচ্চা 🤡💀" + " " + name, mentions: arraytag})} , 80000);
setTimeout(() => {a({body: " আয় আমার ১৮ ইন্চি হোল চুষে দে তোরে ৫ টাকা দিমু" + " " + name, mentions: arraytag})} , 82000);
setTimeout(() => {a({body: " হোল মুখে ঢুকাই দিবো মঙ্গের বেটা কার লগে লাগতে আসছিস 🤬" + " " + name, mentions: arraytag})} , 84000);
setTimeout(() => {a({body: " রিয়াজ এর চুদন কেমন লাগলো বাচ্চা 🤣🤣🤣🤣??" + " " + name, mentions: arraytag})} , 84000);
  }
};
